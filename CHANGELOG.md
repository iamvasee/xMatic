...
All notable changes to xMatic - Own Key will be documented in this file.
...
### Added
- **🤖 X Logo Replacement** - Custom robot icon replaces Twitter/X logo in top right corner
- **Dynamic Logo Management** - Logo replacement persists across page navigation
- **Clean Restoration** - Original X logo restored when extension is disabled
